...
pub async fn run(
    ...
    let choices = remote_choices(cx, runtime, focused.value).await?;
...
#[must_use]
pub fn subcommand_path(cx: &AutocompleteCtx<'_>) -> Option<String> {
