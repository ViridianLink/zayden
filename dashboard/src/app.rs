...
use crate::ui::components::layout::Layout;
...
use crate::ui::pages::modules::ModulesPage;
...
#[derive(Clone)]
pub struct DiscordBotToken(pub String);
        ...
        <Router>
            <Routes fallback=|| view! { <NotFound/> }>
                ...
                <ParentRoute path=path!("/") view=Layout>
                    ...
                    <Route path=path!("guild/:id/modules") view=ModulesPage/>
                </ParentRoute>
            </Routes>
        </Router>
    }
