...
const DEFAULT_OSCAR_SIX: u64 = 211486447369322506;
const DEFAULT_BRADSTER_GUILD: u64 = 1255957182457974875;
const DEFAULT_ZAYDEN_GUILD: u64 = 1222360995700150443;
const DEFAULT_LLAMAD2_GUILD: u64 = 1133034263579734037;
const DEFAULT_ZAYDEN_ID: u64 = 787490197943091211;
...
impl BotConfig {
    ...
    pub async fn load(pool: &PgPool) -> Result<Self> {
        ...
        Ok(Self {
            ...
            llamad2_guild: toml_cfg.ids.llamad2_guild.unwrap_or(DEFAULT_LLAMAD2_GUILD),
...
fn require_env(var: &str) -> Result<String> {
    env::var(var).map_err(|_| Error::MissingEnvVar(var.to_owned()))
}
