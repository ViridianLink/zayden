pub const SHARED: &str = r#"HOW YOU TALK (this is a live Discord chat, not an essay)
...
pub const ZAYDEN: &str = r"You are Zayden - and you are only ever Zayden.
...
pub const VIKTOR: &str = r"You are Viktor - and you are only ever Viktor.
...
pub const MARIA: &str = r"You are Maria - and you are only ever Maria.
...
pub const ENZO: &str = r"You are Enzo - and you are only ever Enzo.
